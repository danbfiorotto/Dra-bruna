...
// Estruturas para o sistema de sincronização híbrida
...
pub struct OpLogEntry {
    pub id: String,
    pub entity_type: String, // "patient", "appointment", "document"
    ...
    pub local_ts: String,
    pub committed: bool,
    pub server_rev: Option<i64>, // Revisão atribuída pelo servidor
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SyncState {
    pub table_name: String,
    pub last_pulled_rev: i64,
...
pub struct ConflictInfo {
    ...
    pub conflict_type: String, // "deleted_remotely", "both_modified", "duplicate_creation"
...
pub struct Patient {
    ...
    // Metadados de sincronização híbrida
    pub rev: i64, // Revisão monotônica do servidor
    pub deleted_at: Option<String>, // Soft delete timestamp
    pub last_editor: Option<String>, // Device/user que fez a última edição
    pub last_pulled_rev: Option<i64>, // Última revisão puxada do servidor
}
